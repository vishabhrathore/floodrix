...
import { ArrowLeft, Layout, FileText, Monitor, Loader2 } from "lucide-react";
...
export default function WorkflowRunPage({ params }: RunPageProps) {
    ...
    const { data: workflow } = useQuery(trpc.calcWorkflows.getOne.queryOptions({ id: workflowId }));
    ...
    return (
        <div className="flex h-screen flex-col bg-neutral-50">
            ...
            <div className="flex items-center gap-3 border-b bg-white px-4 py-2">
                ...
                <Tabs value={viewMode} onValueChange={(v) => setViewMode(v as any)}>
                    <TabsList className="h-8 p-1">
                        ...
                        <TabsTrigger value="canvas" className="h-6 text-[11px] gap-1.5 px-3">
            ...
            {viewMode === "canvas" ? (
                <>
                    {/* ── Toolbar ──────────────────────────────────────────── */}
                    <WorkflowToolbar workflowId={workflowId} onOpenRunner={handleOpenRunner} />
