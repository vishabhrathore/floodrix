...
export default function CalculatorPage() {
  ...
  if (!calculator)
    return (
      <div className="p-20 text-center font-serif text-[#0a0a0a]">
  ...
  const showApplicabilityWarning =
    calculator.id === "calc-rational" && areaValue > 50;
        ...
        <div className="flex items-start gap-5">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span className="text-[11px] font-bold uppercase tracking-[0.1em] text-[#a1a1a1]">
            ...
            <button
              ...
              className={cn(
                ...
                mode === "single"
                  ...
                  : "text-[#a1a1a1] hover:text-[#525252]",
              )}
            >
              <Play
                size={12}
                fill={mode === "single" ? "currentColor" : "none"}
              />
              Single Run
            </button>
            <button
            ...
            <div className="space-y-10">
              <div className="flex items-center justify-between border-b border-[#e8e8e8] pb-6">
                <div className="space-y-1">
                  <h4 className="text-[16px] font-semibold text-[#0a0a0a]">
                    Analytical Inputs
                  </h4>
                  <p className="text-[10px] font-bold uppercase tracking-[0.15em] text-[#a1a1a1]">
              ...
              <AnimatePresence>
                {showApplicabilityWarning && (
                  ...
                  >
                    ...
                    />
                    <div className="space-y-1">
                      <p className="text-[11px] font-bold text-[#92400e] uppercase tracking-tight">
                        Applicability Warning
                      </p>
                      <p className="text-[12px] text-[#b45309] leading-relaxed">
                        The Rational Method is deterministic and primarily
                        intended for small catchments. Areas exceeding 50 acres
                        (currently {areaValue} acres) may require unit
                        hydrograph or simulation methods for accurate peak
                        discharge.
                      </p>
                    </div>
                  </motion.div>
              ...
              <div className="flex flex-col gap-10">
                ...
                <div className="group relative flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-[#e8e8e8] bg-[#fafafa] p-10 text-center transition-all hover:border-[#0070f3]/50 hover:bg-[#0070f3]/[0.02]">
                  <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-white shadow-sm ring-1 ring-[#e8e8e8] group-hover:ring-[#0070f3]/20 transition-all">
                    <FileText
                      className="text-[#a1a1a1] group-hover:text-[#0070f3] transition-all"
                      size={24}
                    />
                  </div>
                  <h5 className="text-[15px] font-semibold text-[#0a0a0a] mb-2">
                    Technical Dataset Upload
                  </h5>
                  <p className="text-[12px] text-[#a1a1a1] leading-relaxed max-w-md mx-auto">
                    Drag and drop your .xlsx or .csv engineering sheet here to
                    begin high-throughput batch processing across all
                ...
                <div className="space-y-10">
                  <div className="flex items-center justify-between border-b border-[#e8e8e8] pb-6">
                    <div className="space-y-1">
                      <h5 className="text-[16px] font-semibold text-[#0a0a0a]">
                        Manual Parameter Grid
                      </h5>
                      <p className="text-[10px] font-bold uppercase tracking-[0.15em] text-[#a1a1a1]">
                        Direct Tabular Entry
                      </p>
                    </div>
                    ...
                    <table className="w-full text-left text-[11px]">
                      <thead>
                        <tr className="bg-[#fafafa] border-b border-[#e8e8e8]">
                          <th className="px-5 py-4 font-bold uppercase tracking-widest text-[#a1a1a1] text-[10px] w-16 text-center">
                            #
                          </th>
                          {calculator.variables.map((v) => (
                            <th
                              key={v.key}
                              className="px-5 py-4 font-bold uppercase tracking-widest text-[#a1a1a1] text-[10px] min-w-[120px]"
                            >
                              {v.notation || v.label} ({v.unit})
                            </th>
                          ))}
                          <th className="px-5 py-4 font-bold uppercase tracking-widest text-[#e11d48] text-[10px] text-right min-w-[150px]">
                            Analytical Result
                          </th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-[#e8e8e8]/50">
                        {[0, 1, 2].map((idx) => (
                          ...
                          >
                            <td className="px-5 py-3.5 text-[#a1a1a1] font-mono text-center">
                              {idx + 1}
                            </td>
                            {calculator.variables.map((v) => (
                        ...
                        <tr>
                          <td
                            colSpan={calculator.variables.length + 2}
                            className="px-5 py-4 text-center bg-[#fafafa]/30"
                          >
                            <button className="text-[10px] font-bold uppercase tracking-widest text-[#e11d48] hover:underline transition-all">
                              + Initialize New Analysis Row
                            </button>
                          </td>
                        </tr>
                      </tbody>
              ...
              <div className="space-y-10">
                ...
                <div className="grid grid-cols-1 gap-6">
                  <div className="rounded-xl border border-[#e8e8e8] bg-white p-6 space-y-4 shadow-sm relative overflow-hidden group">
                    ...
                    <div className="space-y-2">
                      <span className="text-[10px] font-bold text-[#a1a1a1] uppercase tracking-[0.15em]">
                        Peak Runoff Rate
                      </span>
                      <div className="flex items-baseline gap-2">
                        ...
                        <span className="text-sm font-bold text-[#e11d48] uppercase tracking-wide">
                          {calculator.formula.region.includes("India")
                            ? "cumecs"
                            : "cfs"}
                        </span>
                      </div>
                ...
                <div className="rounded-xl border border-[#e8e8e8] bg-white p-7 space-y-5 shadow-sm">
                  ...
                  <p className="text-[13px] text-[#525252] font-normal leading-relaxed">
                    Computational logic derived from{" "}
                    <span className="font-bold text-[#0a0a0a]">
                      {calculator.formula.reference}
                    </span>
                    . This deterministic method is calibrated for peak runoff
                    estimation in small catchments under 50 acres.
                  </p>
                  <div className="flex items-center gap-4 pt-2">
                    ...
                    <Link
                      href="/platform"
                      className="flex items-center gap-2 text-[11px] font-bold text-[#a1a1a1] uppercase tracking-widest hover:text-[#0a0a0a] transition-colors"
                    >
                      <ArrowRight size={14} />
                      Back to Registry
                    </Link>
