...
export default function CookieBanner() {
  ...
  return (
    <div 
      className="fixed bottom-6 left-6 right-6 md:left-auto md:max-w-md bg-background/95 backdrop-blur-md border border-border text-foreground p-6 rounded-3xl shadow-2xl z-[9999] animate-in fade-in slide-in-from-bottom-4 duration-500"
    >
      <div className="flex flex-col gap-4">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="font-serif font-semibold text-foreground text-lg">Cookie Preferences</h3>
        ...
        <p className="text-[10px] text-muted-foreground/60 text-center">
          By clicking accept, you agree to our <a href="/privacy" className="underline hover:text-primary transition-colors">Privacy Policy</a> and <a href="/terms" className="underline hover:text-primary transition-colors">Terms of Use</a>.
        </p>
      </div>
    </div>
  );
