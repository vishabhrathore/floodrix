  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: CalculatorIcon,
        url: "/admin/workflows/calc",
        badge: "189",
      },
      {
        title: "Workspaces",
        icon: LayoutGridIcon,
        url: "/admin/workflows/workspaces",
        badge: "76",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: SigmaIcon,
        url: "/admin/library/formulas",
      },
      {
        title: "Table registry",
        icon: TableIcon,
        url: "/admin/library/tables",
      },
    ],
  },
  {
    ...
    <Sidebar collapsible="icon">
      <SidebarHeader>
        <SidebarMenuItem className="list-none flex flex-col items-start justify-center p-2">
          <SidebarMenuButton
            asChild
            className="gap-x-2 h-12 px-2 hover:bg-transparent"
          >
            <Link href="/admin" prefetch className="flex items-center w-full">
              ...
              <Image
                ...
                width={28}
                height={28}
                className="w-7 h-7 object-contain bg-red-500 rounded p-1"
              />
                    ...
                    <SidebarMenuItem key={item.title}>
                      ...
                      >
                        ...
                        >
                          ...
                          {item.badge && (
                            <span
                              className={`ml-auto text-[10px] px-2 py-0.5 rounded-full font-medium ${item.badgeColor || (isActive ? "bg-red-200 text-red-900" : "bg-secondary text-secondary-foreground")}`}
                            >
                              {item.badge}
                            </span>
                          )}
