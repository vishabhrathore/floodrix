...
function BaseNodeInner({
  ...
  const handleConfigure =
    ...
    (() => {
      window.dispatchEvent(
        new CustomEvent("floodrix:configure-node", { detail: { nodeId: id } }),
      );
    });
  ...
  const executionClass = getExecutionHighlightClass(
    executionStatusValue,
    isActiveExecutionNode,
  );
  ...
  return (
    <div className="group/menu relative">
      ...
      >
        ...
        <div
          style={{ height: 1, backgroundColor: "#f3f4f6", margin: "2px 0" }}
        />
