...
import { canDeleteRegistryItem, canEditRegistryItem, canViewRegistryItem } from "./permission";
...
export const formulaPolicies: ResourcePolicyMap = {
    ...
    delete: (ctx) => !!ctx.formulaItem && canDeleteRegistryItem(ctx, ctx.formulaItem),
