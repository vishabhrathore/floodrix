...
import RegistryPicker, {
  type RegistryItem,
} from "@/features/registery/components/registery-picker";
...
export default function LookupConfigPanel({
  ...
  const handleRegistrySelect = (
    ...
    const outputBinding = outputCol
      ? {
          columnKey: outputCol.key,
          contextKey: "",
          notation: outputCol.key,
          label: outputCol.label,
        }
      : undefined;
  ...
  const updateKeyBinding = (index: number, binding: LookupInputBinding) => {
    const next = localConfig.keyBindings.map((b, i) =>
      i === index ? binding : b,
    );
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-1.5">
                          <Input
                            value={
                              localConfig.outputBinding.contextKey ??
                              localConfig.outputBinding.notation ??
                              ""
                            }
                            onChange={(e) => {
                          ...
                          <p className="mt-1 text-[9px] text-muted-foreground">
                            This name will be available to other nodes in the
                            workflow.
                          </p>
                        </div>
                      </div>
