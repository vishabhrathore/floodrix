    ...
    <div className="group flex items-start gap-2 rounded-md px-2 py-2 hover:bg-slate-50 transition-colors">
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-0.5 flex items-center gap-1.5">
          <span className={cn("text-[10px]", scopeConfig.color)}>
            {scopeConfig.label}
          </span>
          {variable.unit && (
          ...
          <TabsList className="mx-3 mt-2 h-8 flex-shrink-0 grid w-auto grid-cols-2">
            ...
            <TabsTrigger value="variables" className="text-xs gap-1">
              ...
              {variables.length > 0 && (
                <Badge
                  variant="secondary"
                  className="ml-1 h-4 min-w-[16px] rounded-full px-1 text-[9px]"
                >
                  {variables.length}
                </Badge>
              )}
                ...
                {hasCollisions && (
                  <div className="mb-3 flex items-start gap-2 rounded-md border border-amber-200 bg-amber-50 px-2.5 py-2">
                    ...
                    <p className="text-[10px] text-amber-700">
                      Notation collision detected. Some symbols refer to
                      multiple variables.
                    </p>
                  </div>
                )}
                ...
                {variables.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-8 text-center">
                    ...
                    <p className="text-[10px] text-slate-400 mt-1">
                      Variables are created automatically when you configure
                      nodes
                    </p>
                  </div>
                ) : (
