            ...
            children: [
              {
                ...
                description:
                  "The global standard for peak runoff rate calculation in small watersheds (typically < 50 hectares). Verified for urban drainage design.",
              ...
              },
              {
                ...
                description:
                  "Regional peak discharge estimation for North Indian catchments. Applicable for large natural watersheds with regional adjustment factors per IRC:SP:13-2004 §3.1.",
                categoryLabel: "Empirical Hydrology (North India)",
                variables: [
                  {
                    key: "Cd",
                    label: "Dicken's Constant",
                    notation: "Cd",
                    unit: "—",
                    defaultValue: 11.5,
                    hint: "Range: 6 to 30",
              ...
              },
              {
                ...
                description:
                  "Specialized peak discharge estimation for South Indian catchments. Incorporates regional basin characteristics per IRC:SP:13-2004 §3.2.",
                categoryLabel: "Empirical Hydrology (South India)",
                variables: [
                  {
                    key: "Cr",
                    label: "Ryve's Constant",
                    notation: "Cr",
                    unit: "—",
                    defaultValue: 6.8,
                    hint: "Range: 6.8 to 40",
                  },
                  {
                    key: "A",
                    label: "Catchment Area",
            ...
            children: [
              {
                ...
                description:
                  "Automated verification of nominal moment capacity for reinforced concrete sections per limit state principles.",
                      ...
                      steps: [
                        {
                          label: "Steel Area",
                          notation: "As",
                          value: vals.As.toString(),
                          unit: "in²",
                        },
                        {
                          label: "Steel Yield",
                          notation: "fy",
                          value: vals.fy.toString(),
                          unit: "psi",
                        },
                        {
                          label: "Depth",
                          notation: "d",
                          value: vals.d.toString(),
                          unit: "in",
                        },
                        {
                          label: "Comp. Block",
