...
export function createExecutionSnapshot(ctx: RequestContext): ExecutionAuthSnapshot {
    ...
    if (isOrgAdmin(ctx)) {
        ...
        else if (perm === CollaboratorPermission.EDIT) roleLevel = "COLLABORATOR_EDIT";
        else if (perm === CollaboratorPermission.VIEW) roleLevel = "COLLABORATOR_VIEW";
    }
