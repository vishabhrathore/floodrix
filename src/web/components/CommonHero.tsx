...
const CommonHero: React.FC<CommonHeroProps> = ({
  ...
  return (
    <section ref={sectionRef} id={id} data-header-theme="dark" className="hero-section relative min-h-[90vh] bg-brand-dark flex flex-col justify-end px-6 md:px-20 lg:px-32 pb-24 overflow-hidden pt-32">
