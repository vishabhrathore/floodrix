      ...
      return {
        ...
        vars: [
          { k: "M", d: "Catchment Area", v: r.M, u: "Km²" },
          {
            k: "√(M+10)",
            d: "Square root term",
            v: parseFloat(Math.sqrt(r.M + 10).toFixed(3)),
            u: "",
          },
          {
            k: "Q",
      ...
      return {
        ...
        vars: [
          ...
          { k: "C", d: "Creager's Constant", v: r.C_cf, u: "" },
          {
            k: "0.386A",
            d: "0.386 × A",
            v: parseFloat((0.386 * r.M).toFixed(3)),
            u: "",
          },
          {
            k: "Q",
        ...
        vars: [
          {
            ...
            v: parseFloat(H.toFixed(3)),
            u: "m",
          },
          {
            k: "tc_calc",
            d: "(0.87·L³/H)^0.385",
            v: parseFloat(tc_c.toFixed(3)),
            u: "hr",
          },
          {
            k: "tc",
            d: "Adopted tc (min 2.72 hr)",
            v: parseFloat(tc.toFixed(3)),
            u: "hr",
          },
          {
            k: "Ic",
            d: "Ic = (F/24)·(25/(tc+1))",
            v: parseFloat(Ic.toFixed(3)),
            u: "cm/hr",
          },
...
const EngineeringPlatform: React.FC = () => {
  ...
  const [batchProcessedData, setBatchProcessedData] = useState<any[] | null>(
    null,
  );

  const resultRef = useRef<HTMLDivElement>(null);
  const heroRef = useSectionTheme("platform-hero", "dark");
  ...
  return (
    <div className="min-h-screen bg-[#fcfcfc] pb-32 selection:bg-brand-red selection:text-white">
      ...
      <div className="relative pt-40 md:pt-48 px-6 md:px-20 lg:px-32 max-w-[1920px] mx-auto">
        ...
        >
          <div className="relative overflow-hidden rounded-[4rem] p-16 md:p-24 mb-20">
            ...
            <div
              ref={heroRef}
              id="hero-section"
              className="absolute inset-0 bg-brand-dark/95 backdrop-blur-3xl z-0"
            />
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-20">
                ...
                >
                  ...
                  <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-serif text-white leading-[1.1] font-medium tracking-tight">
                    Analytical <br />
                    <span className="italic text-white underline decoration-brand-red decoration-2 underline-offset-8">
                      Hydrology Engine.
                    </span>
                  </h1>
                </motion.div>
                ...
                <div className="flex bg-white/5 backdrop-blur-xl p-2 rounded-2xl border border-white/10 shadow-2xl">
                  <button
                    ...
                    className={`px-10 py-3.5 rounded-xl text-[10px] font-bold uppercase tracking-[0.2em] transition-all duration-500 ${
                      mode === "manual"
                        ? "bg-brand-red text-white shadow-[0_8px_20px_-5px_rgba(251,54,64,0.5)]"
              ...
              <div className="flex flex-wrap gap-8 md:gap-16 border-b border-white/5 pb-10">
                {Object.entries(TREE).map(([id, item], idx) => (
                  <button
                    ...
                    className={`flex items-center gap-4 transition-all relative group h-full pb-2 ${
        ...
        <div
          id="expertise"
          className="relative z-10 px-6 md:px-20 lg:px-32 -mt-12"
        >
          ...
          <div className="flex items-center gap-3 mb-16 text-[9px] font-bold uppercase tracking-[0.3em] text-gray-400 bg-white border border-gray-100 px-8 py-5 rounded-2xl shadow-[0_15px_50px_-15px_rgba(0,0,0,0.08)] w-fit ring-1 ring-black/[0.02]">
            <button
              ...
              className="hover:text-brand-red transition-all flex items-center gap-2"
            >
            ...
            <span
              className={
                path.length === 0 && mode === "manual" ? "text-brand-dark" : ""
              }
            >
  ...
  return (
    <div className="space-y-16 animate-in fade-in slide-in-from-bottom-8 duration-1000 ease-out">
      <div className="max-w-3xl">
        ...
        >
          Select <br />
          <span className="italic text-brand-red">Analytical Domain.</span>
        </motion.h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        {node.children &&
          Object.entries(node.children).map(([id, child], idx) => {
            ...
            return (
              <motion.button
                ...
                disabled={isStub}
                onClick={() => onSelect(id)}
                className={`bg-white group text-left p-12 rounded-[3.5rem] border transition-all duration-700 relative overflow-hidden flex flex-col justify-between min-h-[440px] ${
                  isStub
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="w-20 h-20 bg-gray-50 group-hover:bg-brand-red/5 rounded-3xl flex items-center justify-center transition-all duration-700 mb-12 group-hover:scale-110 group-hover:rotate-3 shadow-sm border border-gray-100">
                    <div className="text-4xl filter group-hover:drop-shadow-lg transition-all">
                      {child.icon}
                    </div>
                  </div>
                  <h3 className="text-3xl font-bold text-brand-dark mb-4 font-serif tracking-tight leading-none">
                    {child.label}
                  </h3>
                  <p className="text-gray-400 text-base leading-relaxed mb-10 line-clamp-3 font-light">
                    {fDef
                      ? `${fDef.expr} — Advanced hydrological modelling calibrated for ${fDef.region} environments.`
                      : child.desc}
                  </p>
                </div>
  ...
  return (
    <div className="space-y-16 animate-in fade-in slide-in-from-bottom-8 duration-1000 ease-out">
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 pb-8 border-b border-gray-100">
        <div className="max-w-3xl">
          <h1 className="text-5xl md:text-6xl font-serif text-brand-dark mb-6 tracking-tight leading-none">
            {fDef.name}
          </h1>
        ...
        <div className="lg:col-span-4 bg-white rounded-[3rem] border border-gray-100 overflow-hidden shadow-[0_40px_100px_-30px_rgba(0,0,0,0.05)] ring-1 ring-black/[0.01]">
          <div className="bg-brand-dark px-10 py-8 flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-[9px] text-white/40 uppercase tracking-[0.4em] font-mono">
                Parameters Registry
              </p>
            </div>
          </div>
          ...
          {result ? (
                ...
                <div className="bg-white rounded-[3.5rem] p-12 border border-gray-100 shadow-[0_50px_120px_-30px_rgba(0,0,0,0.06)] relative overflow-hidden group/res ring-1 ring-black/[0.01]">
                  ...
                  <div className="relative z-10 flex flex-col md:flex-row justify-between items-start gap-12">
                    <div className="space-y-8 max-w-sm">
                      <div>
                        ...
                        <h2 className="text-brand-dark text-4xl md:text-5xl font-serif font-medium leading-none tracking-tight">
                          Peak <br />
                          <span className="italic">Discharge.</span>
                        </h2>
                      </div>
                      <p className="text-gray-400 text-sm leading-relaxed font-light">
                        Site-specific hydraulic modeling suggests the following
                        maximum discharge volume for the 100-year return period.
                      </p>
                    ...
                    <div className="relative flex flex-col items-center md:items-end justify-center">
                      <div className="text-[12px] font-mono font-bold text-gray-300 uppercase tracking-[0.6em] mb-4">
                        Magnitude
                      </div>
                      <div className="flex items-baseline gap-4">
                        ...
                        <div className="flex flex-col">
                          <span className="text-brand-red font-serif text-3xl italic font-bold">
                            Q
                          </span>
                          <span className="text-gray-300 font-mono text-sm leading-none">
                            m³/s
                          </span>
                        </div>
                      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  ...
                  <div className="bg-white rounded-[3rem] border border-gray-100 overflow-hidden shadow-sm ring-1 ring-black/[0.01]">
                    <div className="px-10 py-8 border-b border-gray-50 flex items-center justify-between bg-gray-50/30">
                      <h3 className="text-[11px] font-bold uppercase tracking-[0.4em] text-gray-500 font-mono">
                        Mathematical Proof
                      </h3>
                    ...
                    <div className="p-10">
                      <div className="space-y-6">
                        {result.vars.map((v: any, idx: number) => (
                          <div
                            key={idx}
                            className={`flex justify-between items-center p-5 rounded-2xl border transition-all ${v.result ? "bg-brand-dark border-brand-dark shadow-xl" : "bg-white border-gray-100 hover:border-gray-200"}`}
                          >
                            <div className="space-y-1">
                              <span
                                className={`text-[10px] uppercase font-mono font-bold tracking-widest ${v.result ? "text-brand-red" : "text-gray-300"}`}
                              >
                                Variable {idx + 1}
                              </span>
                              <h4
                                className={`text-sm font-bold font-serif ${v.result ? "text-white" : "text-brand-dark"}`}
                              >
                                {v.d}
                              </h4>
                            </div>
                            <div className="text-right">
                              <div
                                className={`text-xl font-mono font-black tracking-tight ${v.result ? "text-white" : "text-brand-dark"}`}
                              >
                                {v.v}
                              </div>
                  ...
                  <div className="bg-white rounded-[3rem] border border-gray-100 overflow-hidden shadow-sm ring-1 ring-black/[0.01]">
                    ...
                    <div className="p-10 space-y-8">
                      <div className="grid grid-cols-2 gap-6">
                        <div
                          className={`p-8 rounded-[2rem] border-2 transition-all duration-700 ${(result as any).waterway.P_lacey <= (result as any).waterway.W_linear ? "border-brand-teal bg-brand-teal/[0.03] shadow-lg" : "border-gray-50 bg-gray-50/50 grayscale opacity-40"}`}
                        >
                          <div className="text-[9px] font-bold text-gray-400 uppercase tracking-[0.3em] mb-4 font-mono">
                            Lacey's Regime
                          </div>
                          <div className="text-3xl font-serif font-black text-brand-dark tracking-tighter">
                            {(result as any).waterway.P_lacey.toFixed(2)}
                            <span className="text-sm font-mono ml-1">m</span>
                          </div>
                        </div>
                        <div
                          className={`p-8 rounded-[2rem] border-2 transition-all duration-700 ${(result as any).waterway.W_linear < (result as any).waterway.P_lacey ? "border-brand-teal bg-brand-teal/[0.03] shadow-lg" : "border-gray-50 bg-gray-50/50 grayscale opacity-40"}`}
                        >
                          <div className="text-[9px] font-bold text-gray-400 uppercase tracking-[0.3em] mb-4 font-mono">
                            Linear Waterway
                          </div>
                          <div className="text-3xl font-serif font-black text-brand-dark tracking-tighter">
                            {(result as any).waterway.W_linear.toFixed(2)}
                            <span className="text-sm font-mono ml-1">m</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="p-8 bg-brand-dark rounded-3xl relative overflow-hidden group">
                        ...
                        <div className="relative z-10 flex items-center justify-between">
                          <div>
                            <div className="text-brand-teal text-[9px] font-black uppercase tracking-[0.4em] mb-2 font-mono">
                              Recommendation
                            </div>
                            <h4 className="text-white text-xl font-serif">
                              Minimum{" "}
                              <span className="italic">Span Required.</span>
                            </h4>
                          </div>
                          <div className="text-right">
                            <span className="text-white text-4xl font-serif font-black">
                              {(result as any).waterway.min.toFixed(2)}
                            </span>
                            <span className="text-brand-teal font-mono text-xs ml-2">
                              METERS
                            </span>
                          </div>
                        </div>
                      ...
                      <p className="text-[10px] text-gray-400 italic leading-relaxed text-center px-4">
                        * Results based on IRC:SP:13-2004 compliance standards
                        for bridge crossing optimization.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-white rounded-[4rem] border border-gray-100 p-12 shadow-[0_60px_120px_-30px_rgba(0,0,0,0.04)] ring-1 ring-black/[0.01]">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-16">
                      <div className="space-y-3">
                        <span className="text-brand-red text-[11px] font-bold uppercase tracking-[0.5em] font-mono">
                          Analytical Curve
                        </span>
                        <h3 className="text-3xl font-serif text-brand-dark leading-none">
                          Sensitivity{" "}
                          <span className="italic">Projection.</span>
                        </h3>
                      </div>
                    ...
                    <div className="relative h-[400px] w-full bg-gray-50/50 rounded-[2.5rem] border border-dashed border-gray-200 p-10 overflow-hidden">
                      ...
                      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-12 bg-white/80 backdrop-blur-md px-8 py-3 rounded-2xl border border-white/20 shadow-sm">
                        <div className="flex flex-col items-center">
                          <span className="text-[9px] text-gray-400 uppercase tracking-widest mb-1 font-mono">
                            {result.chartXLabel || "Parameter"}
                          </span>
                          <span className="text-sm font-serif font-black text-brand-dark">
                            {result.chartX.toFixed(2)}
                          </span>
                        </div>
                        <div className="h-8 w-px bg-gray-200" />
                        <div className="flex flex-col items-center">
                          <span className="text-[9px] text-gray-400 uppercase tracking-widest mb-1 font-mono">
                            {result.chartYLabel || "Output"}
                          </span>
                          <span className="text-sm font-serif font-black text-brand-dark">
                            {result.Q.toFixed(2)}
                          </span>
                  ...
                  <div className="bg-white rounded-[3.5rem] border border-gray-100 p-12 shadow-[0_60px_120px_-30px_rgba(0,0,0,0.04)]">
                    <div className="flex items-center gap-6 mb-12">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-xs mt-2 uppercase tracking-[0.2em] font-mono">
                          {fDef.lookup.sub}
                        </p>
                      </div>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                      {fDef.lookup.rows.map((row, ridx) => (
                        <div
                          key={ridx}
                          className={`p-8 rounded-3xl border-2 transition-all duration-500 relative overflow-hidden ${
                        ...
                        >
                          ...
                          <div className="text-[9px] font-bold text-gray-300 uppercase tracking-widest mb-4 font-mono">
                            Reference Data
                          </div>
                          <div className="text-base font-bold text-brand-dark mb-2 font-serif">
                            {row[1]}
                          </div>
            ...
            <div className="h-full flex flex-col items-center justify-center text-center space-y-10 animate-in fade-in zoom-in duration-1000 grayscale opacity-30">
              ...
              <div className="max-w-xs space-y-4">
                <h3 className="text-3xl font-serif text-brand-dark">
                  Engine Standby.
                </h3>
                <p className="text-sm text-gray-400 leading-relaxed font-light">
                  Computation logic is primed. Modify input vectors and execute
                  analysis to initiate simulation.
                </p>
              </div>
            </div>
          )}
...
const BatchView = ({
      ...
      <div className="h-[60vh] flex flex-col items-center justify-center text-center space-y-10">
        ...
        <div className="max-w-sm space-y-6">
          ...
          <p className="text-gray-400 text-lg font-light leading-relaxed">
            ...
            <span className="italic">Analytical Domain</span> to select a
            specific formula before initiating batch processing.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="space-y-16 animate-in fade-in slide-in-from-bottom-8 duration-1000 ease-out">
      <div className="max-w-3xl">
        <span className="text-brand-red text-[11px] font-bold uppercase tracking-[0.5em] mb-8 block font-mono">
          Matrix Processing Engine
        </span>
        <h2 className="text-5xl md:text-6xl font-serif text-brand-dark mb-8 leading-tight tracking-tight">
          Batch <br />
          <span className="italic">Grid Processor.</span>
        </h2>
        <p className="text-gray-400 text-xl font-light leading-relaxed">
          Execute simultaneous computations for{" "}
          <span className="font-bold text-brand-dark">{fDef.name}</span> across
          large datasets via .xlsx or .csv ingestion.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        <div className="lg:col-span-4 space-y-10">
          <div
            ...
            className={`p-12 border-2 border-dashed rounded-[3rem] transition-all duration-700 cursor-pointer flex flex-col items-center justify-center text-center gap-6 group relative overflow-hidden ${
              isDragging
                ? "border-brand-red bg-brand-red/[0.02]"
                : "border-gray-200 hover:border-brand-red/30 bg-white hover:bg-[#fcfcfc]"
            }`}
          >
            ...
            />
            <div
              className={`w-24 h-24 rounded-3xl flex items-center justify-center transition-all duration-700 ${isDragging ? "bg-brand-red text-white" : "bg-gray-50 text-gray-300 group-hover:bg-brand-red group-hover:text-white"}`}
            >
              {batchFile ? (
            ...
            <div className="space-y-2 relative z-10">
              <h4 className="text-xl font-bold font-serif text-brand-dark">
                {batchFile ? batchFile.name : "Ingest Spreadsheet"}
              </h4>
          ...
          <div className="bg-brand-dark rounded-[2.5rem] p-10 space-y-8 relative overflow-hidden ring-1 ring-white/5 shadow-2xl">
            ...
            <div className="space-y-4 relative z-10">
              <span className="text-[10px] font-bold text-brand-red uppercase tracking-[0.4em] block font-mono">
                Instructions
              </span>
              <p className="text-white/60 text-sm leading-relaxed font-light italic">
                Dataset columns must exactly match the computation signature
                keys:
              </p>
              <div className="flex flex-wrap gap-2 pt-2">
                {fDef.fields.map((f) => (
                  <code
                    key={f.key}
                    className="bg-white/5 text-brand-red px-3 py-1 rounded-lg font-mono text-[11px] border border-white/10 uppercase"
                  >
                    {f.key}
                  </code>
                ))}
            ...
            <button
              ...
              disabled={!batchFile}
              className={`w-full py-5 rounded-2xl font-black text-xs tracking-[0.5em] uppercase transition-all duration-700 relative z-10 flex items-center justify-center gap-4 group ${
                batchFile
                  ? "bg-brand-red text-white shadow-lg hover:shadow-brand-red/40 hover:-translate-y-1"
                  : "bg-white/5 text-white/20 cursor-not-allowed"
              }`}
            >
              <Activity
                className={`w-5 h-5 ${batchFile ? "animate-pulse" : ""}`}
              />
              Process Batch
            </button>
          </div>
        ...
        <div className="lg:col-span-8">
          {batchProcessedData ? (
            ...
            >
                ...
                <table className="w-full text-left">
                  <thead>
                    <tr className="bg-gray-50/50 border-b border-gray-100 text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                      ...
                      {fDef.fields.slice(0, 3).map((f) => (
                        <th key={f.key} className="px-10 py-6">
                          {f.key}
                        </th>
                      ))}
                      <th className="px-10 py-6 text-brand-red font-black bg-brand-red/5">
                        Result (Q)
                      </th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-50">
                    {batchProcessedData.slice(0, 10).map((row, i) => (
                      ...
                      >
                        <td className="px-10 py-6 text-xs font-mono font-bold text-gray-500">
                          #{String(i + 1).padStart(3, "0")}
                        </td>
                        {fDef.fields.slice(0, 3).map((f) => (
                          <td
                            key={f.key}
                            className="px-10 py-6 text-xs font-mono text-gray-600"
                          >
                            {row[f.key]}
                          </td>
                        ))}
                        <td className="px-10 py-6 text-xs font-mono font-black text-brand-red bg-brand-red/[0.02]">
                          {row.Q_result}
                        </td>
                      </tr>
                    ))}
              ...
              <div className="p-10 border-t border-gray-50 bg-gray-50/20 text-center">
                <p className="text-[11px] text-gray-400 font-medium italic">
                  Only first 10 records shown in preview. Full computation
                  result downloaded as{" "}
                  <span className="text-brand-dark font-bold underline">
                    floodrix_batch_results.xlsx
                  </span>
                </p>
              </div>
            </motion.div>
            ...
            <div className="h-[600px] rounded-[3rem] border-2 border-dashed border-gray-100 flex flex-col items-center justify-center text-center p-12 grayscale opacity-40">
              ...
              <div className="max-w-xs space-y-4">
                <h3 className="text-2xl font-serif text-brand-dark leading-tight">
                  Standby for Matrix.
                </h3>
                <p className="text-xs text-gray-400 leading-relaxed font-light px-6">
                  Upload a valid dataset to visualize the batch processing
                  pipeline results in real-time.
                </p>
              </div>
            </div>
          )}
