        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 lg:gap-32 mb-32 items-start footer-stagger">
          ...
          <div className="lg:col-span-4 space-y-8 footer-stagger">
            <h3 className="text-2xl md:text-3xl font-serif leading-tight text-white/90">
              Transforming <span className="italic text-brand-red">water hazards</span> into infrastructure assets.
            </h3>
            <p className="text-white/40 leading-relaxed font-light text-lg">
              We leverage advanced computational hydraulics and decades of engineering expertise to build climate-resilient water systems for the modern world.
            </p>
            <div className="flex space-x-4 pt-4">
              <a href="#" className="bg-white/5 p-4 rounded-full hover:bg-brand-red transition-all group border border-white/5 hover:border-brand-red"><Linkedin className="w-5 h-5 group-hover:scale-110 transition-transform" /></a>
              <a href="#" className="bg-white/5 p-4 rounded-full hover:bg-brand-red transition-all group border border-white/5 hover:border-brand-red"><Twitter className="w-5 h-5 group-hover:scale-110 transition-transform" /></a>
              <a href="#" className="bg-white/5 p-4 rounded-full hover:bg-brand-red transition-all group border border-white/5 hover:border-brand-red"><Facebook className="w-5 h-5 group-hover:scale-110 transition-transform" /></a>
            </div>
          </div>
          ...
          <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 footer-stagger">
            ...
            <div className="footer-stagger">
              <h4 className="text-[10px] font-mono font-bold uppercase tracking-[0.5em] mb-10 text-brand-red">Solutions</h4>
              <ul className="space-y-6 text-white/50 font-light text-base">
                <li><a href="#" className="hover:text-white hover:pl-2 transition-all">Hydraulics & Hydrology</a></li>
                <li><a href="#" className="hover:text-white hover:pl-2 transition-all">Flood Risk Assessment</a></li>
                <li><a href="#" className="hover:text-white hover:pl-2 transition-all">Highway Drainage</a></li>
                <li><a href="#" className="hover:text-white hover:pl-2 transition-all">Urban Modelling</a></li>
                <li><a href="#" className="hover:text-white hover:pl-2 transition-all">Groundwater Systems</a></li>
              </ul>
            </div>
            ...
            <div className="space-y-10 footer-stagger">
              <h4 className="text-[10px] font-mono font-bold uppercase tracking-[0.5em] mb-10 text-brand-red">Headquarters</h4>
