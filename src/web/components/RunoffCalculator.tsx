          ...
          >
            <div className="space-y-6">
              ...
              <h3 className="text-h1 text-white font-serif tracking-tight leading-[1.1]">
                Advanced Hydrological <span className="text-brand-red italic">Solutions.</span>
              </h3>
            ...
            <div className="relative bg-[#0f0f0f] rounded-[2rem] border border-white/10 shadow-xl overflow-hidden">
              ...
              <div className="bg-[#1a1a1a] px-6 py-4 flex items-center border-b border-white/10">
                ...
                <div className="flex-1 text-center">
                  <span className="text-[9px] font-mono text-white/40 uppercase tracking-[0.3em] ml-[-40px]">Rational_Runoff_Simulator.dmg</span>
                </div>
              </div>
                ...
                <div className="space-y-10">
                  ...
                  <div className="grid grid-cols-1 gap-8">
                    <div className="space-y-4">
                      <div className="flex justify-between text-[11px] font-bold uppercase tracking-widest text-white/40 font-mono">
                        ...
                        <span className="text-brand-red">{coefficient.toFixed(2)}</span>
                      </div>
                      <input
                  ...
                  <div className="bg-black border border-white/10 rounded-[2rem] p-10 text-center relative group overflow-hidden shadow-2xl">
                    ...
                    <div className="relative z-10 space-y-4">
                      <h4 className="text-[10px] font-mono tracking-[0.5em] uppercase text-white/40">Peak Discharge</h4>
                      <motion.div className={`text-h1 font-serif font-bold tracking-tighter ${getSeverityColor(q)}`}>
                        {displayResult}
                      </motion.div>
                      <div className="text-white/20 text-[10px] font-mono font-bold tracking-[0.3em] uppercase">m³/sec</div>
                    </div>
                  </div>
                </div>
              </div>
