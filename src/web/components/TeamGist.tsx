          ...
          <div className="flex flex-col lg:flex-row justify-between items-end mb-20 gap-8">
            <div className="max-w-2xl">
              <div className="flex items-center gap-4 mb-6">
                ...
                <span className="text-[10px] font-mono font-bold tracking-[0.4em] text-brand-red uppercase">
                  Our Leadership
                </span>
              </div>
              <h2 className="text-h1 font-serif text-brand-dark tracking-tight leading-tight">
                The engineers behind the{" "}
                <span className="italic text-brand-red">infrastructure.</span>
              </h2>
            </div>
            <Link
              href="/team"
              ...
              <div className="group">
                <div className="relative aspect-[4/5] rounded-[2rem] overflow-hidden mb-6">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-brand-dark/95 via-brand-dark/30 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 flex flex-col justify-end p-8 transform translate-y-4 group-hover:translate-y-0">
                    ...
                    <span className="text-white text-[9px] font-bold uppercase tracking-[0.3em] opacity-50">
                      {member.role}
                    </span>
                  </div>
                </div>
                <h3 className="text-h3 font-serif text-brand-dark mb-1 group-hover:text-brand-red transition-colors">
                  {member.name}
                </h3>
