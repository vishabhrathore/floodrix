      ...
      <div className="px-6 md:px-20 lg:px-32">
        <div className="flex flex-col lg:flex-row justify-between items-end mb-20 gap-8">
          <div className="max-w-2xl">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif text-brand-dark tracking-tight leading-tight">
              The minds behind the <span className="italic text-brand-red">infrastructure.</span>
            </h2>
          </div>
          <Link 
            href="/team" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {TEAM.slice(0, 4).map((member, idx) => (
            ...
            >
              ...
              <h3 className="text-xl font-serif text-brand-dark mb-1 group-hover:text-brand-red transition-colors">{member.name}</h3>
