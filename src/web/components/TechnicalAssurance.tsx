...
const TechnicalAssurance: React.FC = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="bg-white py-32 border-t border-gray-100 overflow-hidden relative"
    >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-end">
            <div className="lg:col-span-7">
              ...
              <p className="text-gray-600 text-body leading-relaxed font-light border-l-2 border-brand-red pl-6 max-w-2xl">
                Delivering complex water infrastructure requires uncompromising
                adherence to international standards. FloodRix operates under
                stringent quality management protocols and federal regulatory
                frameworks to guarantee engineering integrity and mitigate
                project risk.
              </p>
            </div>
            ...
            <div className="lg:col-span-5 grid grid-cols-1 sm:grid-cols-2 gap-12 lg:gap-8 pb-4">
              <div className="space-y-8">
                <div>
                  <h5 className="text-[10px] font-bold uppercase tracking-[0.3em] text-gray-400 mb-6 border-b border-gray-100 pb-2">
                    Quality Management
                  </h5>
                  <div className="flex items-center gap-4 group cursor-default">
                    ...
                    <div>
                      <div className="text-sm font-bold text-brand-dark uppercase tracking-wider">
                        ISO 9001:2015
                      </div>
            ...
            <div className="flex items-center gap-6">
              <div className="flex -space-x-4">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="w-12 h-12 rounded-full border-4 border-white bg-gray-100 overflow-hidden"
                  >
                    <img
              ...
              <div>
                ...
                <div className="text-[10px] text-gray-400 uppercase tracking-widest">
                  Connect with our Lead Hydrologists
                </div>
              </div>
            </div>
            <motion.button
