...
import { Activity, Map, ShieldCheck, Waves } from "lucide-react";
...
const DomainItem: React.FC<{ domain: Domain; idx: number }> = ({
  domain,
  idx,
}) => {
  ...
  const theme =
    domain.id === "storm-drainage"
      ? "red"
      : domain.id === "groundwater"
        ? "blue"
        : domain.id === "irrigation"
          ? "teal"
          : "dark";
    ...
    theme === "red"
      ...
      : theme === "blue"
        ...
        : theme === "teal"
          ...
          : "bg-brand-dark/5 border-brand-dark/10";
  ...
  return (
    ...
    >
      ...
      {/* Image Section */}
      <div
        className={`w-full lg:col-span-6 relative group ${isContentRight ? "lg:order-1" : "lg:order-2"}`}
      >
        <motion.div
          style={{ y: yImage }}
      ...
      >
        <div className="flex items-center gap-3 mb-8">
          <span
            className={`text-[11px] font-mono font-bold ${textClass} ${bgSubtleClass} px-4 py-1.5 rounded-full border uppercase tracking-[0.3em]`}
          >
            Sector 0{idx + 1}
          </span>
        </div>
        ...
        <div className="mb-8 flex items-center gap-3">
          ...
          <span
            className={`text-[10px] font-mono font-bold uppercase tracking-[0.2em] ${textClass}`}
          >
            {domain.subtitle}
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 gap-y-4 border-t border-gray-100 pt-10">
          ...
          {domain.metrics.map((metric, mIdx) => (
            <div key={mIdx} className="flex items-center gap-4 group/item">
              <div
                className={`w-2 h-2 rounded-full ${accentClass} opacity-40 group-hover/item:opacity-100 group-hover/item:scale-150 transition-all`}
              />
              <span className="text-h5 text-gray-700 font-medium tracking-wide group-hover/item:text-brand-dark transition-colors">
                {metric}
              </span>
            </div>
          ))}
...
const WorkStorytelling: React.FC = () => {
  const domains = [
    {
      ...
      image:
        "https://res.cloudinary.com/dpdkzg4ld/image/upload/v1778512475/floodrix/make_realistic_highway_drainage_image_202605092110.jpg",
    },

    {
      ...
      image:
        "https://res.cloudinary.com/dpdkzg4ld/image/upload/v1778512319/floodrix/Cross-section_scientific_illustration_of_underground_202605092110.jpg",
    },

    {
      ...
      image:
        "https://res.cloudinary.com/dpdkzg4ld/image/upload/v1778512329/floodrix/Wide_cinematic_aerial_photograph_of_202605092111.jpg",
    },

    {
      ...
      image:
        "https://res.cloudinary.com/dpdkzg4ld/image/upload/v1778512372/floodrix/create_this_realistic_image_for_202605092110.jpg",
    },
  ];
  ...
  return (
    <section
      ref={sectionRef}
      className="bg-white py-24 lg:py-32 border-t border-gray-200 overflow-hidden relative"
    >
      <div className="w-full px-6 md:px-12 lg:px-24 relative z-10">
        ...
        <div className="mb-20 pb-16">
          <div className="flex items-center gap-4 mb-8">
            ...
            <span className="text-[10px] font-mono font-bold tracking-[0.5em] text-brand-red uppercase">
              Our Domains
            </span>
          </div>
            ...
            <div className="lg:col-span-7">
              <h2 className="text-h1 font-serif text-brand-dark leading-tight tracking-tight">
                ...
                <span className="italic text-brand-red">
                  specialized water domains.
                </span>
              </h2>
            </div>
            <div className="lg:col-span-5">
              <p className="text-gray-600 text-lg leading-relaxed font-light border-l-2 border-brand-red pl-6">
                Strategic consultancy and engineering solutions for complex
                stormwater, groundwater, and irrigation infrastructure.
              </p>
            </div>
          </div>
        </div>
