          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-24">
            {PROJECTS.map((project, idx) => (
              <motion.div
                ...
                className="group"
              >
                <Link href={`/project/${project.id}`} className="block space-y-8">
                  ...
                  <div className="space-y-4 px-2">
                    ...
                    <div className="pt-4 flex items-center justify-between border-t border-gray-50 mt-4">
                      ...
                      <span className="text-[10px] font-mono text-gray-300 font-medium">#{project.id.toUpperCase()}</span>
                    </div>
        ...
        <section className="mt-32 pt-32 border-t border-gray-100">
           <div className="max-w-4xl">
              <h2 className="text-4xl font-serif text-brand-dark tracking-tight mb-8">
                Ready to solve your next <span className="italic text-brand-red">technical challenge?</span>
              </h2>
              <Link 
                href="/contact"
