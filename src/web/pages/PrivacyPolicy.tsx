        ...
        <thead>
          <tr className="border-b-2 border-gray-900">
            {cols.map((c, i) => (
              <th
                key={i}
                className="text-left py-4 pr-8 font-mono font-semibold uppercase tracking-widest text-brand-dark"
              >
                {c}
              </th>
            ))}
          ...
          {rows.map((row, i) => (
            ...
            >
              {row.map((cell, j) => (
                <td
                  key={j}
                  className="py-4 pr-8 text-gray-600 leading-relaxed align-top"
                >
                  {cell}
                </td>
              ))}
      ...
      <div className="w-full px-6 md:px-12 lg:px-24 xl:px-32 relative z-10">
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-end">
            <div className="lg:col-span-7">
              <p className="text-[11px] font-mono text-brand-red uppercase tracking-[0.25em] mb-4">
                Legal
              </p>
              ...
              <p className="text-[15px] text-gray-500 leading-relaxed max-w-xl">
                This document describes how Floodrix collects, processes, and
                protects personal data in connection with the use of the
                Engineering Portal.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 py-16">
          ...
          <main className="lg:col-span-9 lg:border-l lg:border-gray-100 lg:pl-14 text-gray-600 leading-[1.9] space-y-1">
            ...
            <p>
              Floodrix is an engineering consultancy providing hydraulic
              modelling, hydrological assessment, and drainage design services.
              This website is intended for civil engineers, infrastructure
              developers, and government bodies seeking technical resources and
              advisory services.
            </p>
            <p className="mt-3">
              For privacy-related enquiries, contact:{" "}
              <a
                href="mailto:privacy@floodrix.com"
            ...
            <p>
              If you accept analytics cookies, we collect the following via
              Google Analytics 4 through Google Tag Manager. No data of this
              type is collected if you decline or have not yet made a choice:
            </p>
            ...
            <Note>
              This data is aggregated and anonymised. We do not build individual
              user profiles.
            </Note>

            <H3>2b — Contact and enquiry data</H3>
            <p>
              When you submit a project enquiry, we collect your name, email
              address, organisation name (if provided), and message content.
              This is used solely to respond to your enquiry and is not used for
              marketing without separate consent.
            </p>

            <H3>2c — Cookie preference</H3>
            <p>
              We store your consent choice in your browser's local storage. This
              is a functional necessity to remember your preference across
              visits. It does not constitute tracking.
            </p>

            <H3>2d — Data we do not collect</H3>
            <p>
              We do not collect payment card information, sensitive personal
              data (health, religion, ethnicity), data from children under 18,
              or precise geolocation coordinates.
            </p>
            ...
            <DataTable
              ...
              rows={[
                ...
                [
                  ...
                  "Legitimate interest (functional necessity)",
                ],
              ]}
            />
            <p className="mt-2 text-[13px] text-gray-500">
              Under India's Digital Personal Data Protection Act 2023 (DPDP
              Act), we process personal data only for the purposes stated above
              and do not repurpose it without notifying you.
            </p>

            {/* 04 */}
            <H2 id="google">4. Google Analytics and Tag Manager</H2>
            <p>
              We use Google Tag Manager to manage analytics tags. GTM itself
              does not collect personal data. Google Analytics 4 is loaded{" "}
              <strong className="font-semibold text-brand-dark">
                only after you explicitly accept analytics cookies
              </strong>
              . If you reject or have not yet made a choice, no GA4 data
              collection occurs.
            </p>
            <p className="mt-3">
              Google processes analytics data on servers that may be located
              outside India, including in the United States. Google anonymises
              IP addresses before storage and will not associate your IP with
              any other data held by Google. We do not enable Google Signals or
              advertising features. For details, refer to{" "}
              <a
            ...
            <DataTable
              ...
              rows={[
                [
                  "GA4 analytics data",
                  "14 months",
                  "GA4 default; configurable in property settings",
                ],
                [
                  "Contact enquiry emails",
                  "3 years",
                  "From last correspondence",
                ],
                [
                  "Cookie preference",
            ...
            <p>
              ...
              only with the following processors under contractual data
            ...
            <DataTable
              ...
              rows={[
                ...
                [
                  "Email / CRM provider",
                  "Routing and storing contact enquiries",
                ],
              ]}
            />
            <p className="mt-2 text-[13px] text-gray-500">
              We may disclose data where required by law, regulatory authority,
              or court order, including under the DPDP Act 2023.
            </p>
            ...
            <p>
              ...
              access, correct, or erase your personal data, and to withdraw
              consent at any time.
            </p>
            <DataTable
              ...
              rows={[
                ...
                [
                  "Erase your data",
                  "Email privacy@floodrix.com (subject to legal retention obligations)",
                ],
                [
                  "Withdraw analytics consent",
                  "Clear browser local storage — banner reappears on next visit",
                ],
                [
                  "Nominate a representative",
                  "Email privacy@floodrix.com with written authorisation",
                ],
              ]}
            />
            ...
            <p>
              ...
              encryption, access controls on contact form data, and periodic
              security reviews. No transmission over the internet is completely
              secure; we take all reasonable precautions but cannot guarantee
              absolute security.
            </p>
            ...
            <p>
              We will update this policy when our data practices change. The
              revision date at the top of this page will reflect any update. For
              material changes, we will post a notice on the homepage for 30
              days.
            </p>
