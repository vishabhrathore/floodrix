                ...
                <div className="max-w-[72ch]">
                  <Markdown
                    ...
                    components={{
                      h2: ({ node, children, ...props }) => {
                        ...
                        return (
                          <h2
                            ...
                            style={{ fontSize: 'clamp(1.35rem, 2vw, 1.7rem)', lineHeight: 1.2 }}
                            {...props}
                          >
                            {children}
                          </h2>
                      ...
                      h3: ({ node, children, ...props }) => {
                        ...
                        return (
                          <h3
                            ...
                            style={{ fontSize: 'clamp(1rem, 1.4vw, 1.2rem)', lineHeight: 1.35 }}
                            {...props}
                          >
                            {children}
                          </h3>
                      ...
                      p: ({ node, ...props }) => (
                        <p
                          className="font-sans text-gray-700 leading-[1.82] mb-9"
                      ...
                      blockquote: ({ node, ...props }) => (
                        <blockquote
                          className="my-12 border-l-2 border-brand-red pl-8 font-serif italic text-gray-500 bg-gray-50/50 py-4 pr-6"
                      ...
                      table: ({ node, ...props }) => (
                        <div className="overflow-x-auto my-14 border border-gray-100 shadow-sm bg-white">
                          <table className="w-full text-left border-collapse font-sans text-sm" {...props} />
                        </div>
                      ),
                      thead: ({ node, ...props }) => (
